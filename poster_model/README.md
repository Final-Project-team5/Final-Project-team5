...
**손이나 사람이 함께 찍힌 제품 사진.** 누끼가 손을 제품의 일부로 잡으면 최종
합성에서 원본 손이 그대로 덮어씌워집니다. AI가 그린 것이 아니라 옮겨진 것이라
프롬프트로는 막을 수 없습니다. 그 상태에서 배경 생성이 남은 공간을 채우면서
사람이 함께 생성되기도 합니다.

제품만 촬영하도록 안내하는 것이 현재 대응입니다. 다만 말랑이·퍼프처럼 **손에
쥐어야 쓰임새가 드러나는 제품**은 그 안내를 지키기 어렵습니다. 제품만 찍으면
형태와 용도가 보이지 않고, 손을 넣으면 누끼가 손까지 가져갑니다. 안내로 풀리는
문제가 아니라 현재 구조가 다루기 어려운 입력 유형입니다.

입력 해상도도 영향을 줍니다. 작은 이미지에서는 누끼가 제품과 그 외의 경계를
정확히 잡기 어렵습니다.
