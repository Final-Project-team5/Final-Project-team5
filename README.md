...
- **손·사람이 함께 찍힌 제품 사진** — 누끼가 손을 제품의 일부로 인식하면 최종 합성에 원본 손이 그대로 남고, 프롬프트로는 막을 수 없습니다. 말랑이·퍼프처럼 손에 쥐어야 쓰임새가 드러나는 제품은 촬영 안내만으로 해결하기 어려운 유형입니다. 입력 이미지 해상도도 누끼 정확도에 영향을 줍니다.
