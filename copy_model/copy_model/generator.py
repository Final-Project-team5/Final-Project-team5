...
_MOCK_SAMPLES = {
    ...
    "academy": [
        ("배움의 방향을 함께 잡다", "학생별 수준에 맞춘 체계적인 커리큘럼"),
        ("오늘의 질문이 내일의 실력", "기초부터 차근차근 쌓는 맞춤 지도"),
        ("혼자보다 멀리 가는 공부", "꾸준함을 만드는 밀착 관리 수업"),
    ],
    "sports": [
        ("나에게 맞춘 오늘의 운동", "개인별 목표에 맞춘 맞춤 트레이닝"),
        ("꾸준함이 만드는 변화", "전문 지도로 바른 자세부터 차근차근"),
        ("운동이 즐거워지는 공간", "초보자도 편하게 시작하는 프로그램"),
    ],
}
