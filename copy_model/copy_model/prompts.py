...
CATEGORY_GUIDES = {
    ...
    "academy": (
        "업종: 학원/교습소 등 교육 서비스 소상공인.\n"
        "전문성, 커리큘럼, 밀착 관리, 학습 경험을 살린다. "
        "단, 합격·점수·순위·취업을 보장·단정하는 표현은 표시광고법상 금지이므로 "
        "절대 쓰지 않고 '체계적 지도', '과정 중심' 등 사실 기반 표현만 쓴다."
    ),
    "sports": (
        "업종: 체육관/헬스장/도장 등 스포츠 서비스 소상공인.\n"
        "전문 지도, 맞춤 프로그램, 꾸준한 습관, 시설·분위기를 살린다. "
        "단, 환불·중도해지 불가 표시, 배타성·최상급, 지도자 자격 과장, "
        "단기·수치 성과 단정은 규제 대상이므로 쓰지 않고 과정 중심으로 표현한다."
    ),
}
