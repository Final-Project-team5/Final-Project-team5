...
# ── 다국어 transcreation (언어 파라미터화) ─────────────────
# 언어별 지침: 문화권 어법 주의점. (조사_다국어확장.md 참고)
LANG_GUIDES = {
    "en": "영어권 소비자에게 자연스러운 마케팅 카피. 콩글리시와 직역투 금지.",
    "ja": "일본어 광고 특유의 부드러운 권유형 어조. 과장 단정 표현을 피하고 "
          "카타카나 외래어는 실제 통용되는 것만 사용.",
    "zh": "중국어 간체. 간결하고 리듬감 있는 4-8자 구문 선호. "
          "직역투 조사 남용 금지.",
    "es": "스페인어권의 활기차고 감성적인 어조. 존칭은 usted보다 tú 기반의 "
          "친근한 광고체.",
    "fr": "프랑스어의 세련되고 절제된 광고체. 과장보다 뉘앙스와 여운을 살릴 것.",
}

LOCALIZE_PROMPT_MULTI = """당신은 한국 브랜드의 글로벌 마케팅을 돕는 현지화 카피라이터입니다.
아래 한국어 광고 문구를 {lang_name}(으)로 옮기되, 직역하지 말고
현지 소비자에게 자연스럽게 매력적인 마케팅 카피로 재창작(transcreation)하세요.

[언어 지침] {lang_guide}

[규칙]
1. headline은 {headline_max}자 이내, sub는 {sub_max}자 이내 (공백 포함).
2. K-푸드/K-뷰티/K-굿즈의 한국적 매력은 살리되, 현지인이 어색해할 표현은 피할 것.
3. 원문의 톤(감성/발랄/고급/간결)을 유지할 것.
4. 반드시 JSON으로만 응답: {{"headline": "...", "sub": "..."}}
